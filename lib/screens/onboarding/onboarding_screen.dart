...
class _OnboardingScreenState extends State<OnboardingScreen>
  ...
  final List<OnboardingContent> _onboardingData = [
    OnboardingContent(
      ...
      description: 'Your trusted partner for safe and convenient rides across South Africa.',
    ...
    OnboardingContent(
      title: 'Quick & Easy',
      description: 'Book your ride in seconds with our intuitive interface and real-time tracking.',
      icon: Icons.speed,
    ...
    OnboardingContent(
      title: 'Safe & Secure',
      description: 'All our drivers are verified and your rides are fully insured for your peace of mind.',
      icon: Icons.security,
        ...
        Row(
          ...
          children: List.generate(
            ...
            (i) => AnimatedContainer(
              ...
              height: 8,
              decoration: BoxDecoration(
                color: currentPage == i ? content.color : Colors.grey[300],
  ...
  Widget build(BuildContext context) {
    return AnimatedContainer(
      ...
      decoration: BoxDecoration(
        color: isActive 
            ? AppColors.primary 
            : AppColors.getDividerColor(isDark),
