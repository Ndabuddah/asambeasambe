...
import 'package:rideapp/models/notification_model.dart';
import 'package:rideapp/models/user_model.dart';
import 'package:rideapp/screens/auth/login_screen.dart';
import 'package:rideapp/screens/home/driver/earnings_screen.dart';
import 'package:rideapp/screens/permissions/location_permission_screen.dart';
import 'package:rideapp/services/database_service.dart';
...
import 'package:rideapp/screens/driver/ride_history_screen.dart' as driver_history;
  ...
  Future<void> _toggleOnlineStatus() async {
    ...
    if (!userModel.isApproved) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('You must be approved to go online.')),
      );
      return;
    }
                                    ...
                                    if (user?.isApproved == true)
                                      ...
                                      Container(
                                        ...
                                        child: Row(
                                          children: const [
                                            SizedBox(width: 4),
                                            Text('Awaiting approval', style: TextStyle(color: Colors.white, fontSize: 12, fontWeight: FontWeight.bold)),
                                          ],
                                        ),
                                      ),
                                    // Refresh Button
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 12),
              ...(_currentUser?.missingProfileFields ?? []).map((field) => Padding(
            ...
            child: Container(
              ...
              child: Material(
                ...
                child: InkWell(
                  ...
                  child: Icon(
                    widget.icon,
                    color: AppColors.getIconColor(widget.isDark),
                    size: 24,
                  ),
                ),
              ),
          ...
          return Transform.scale(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.circular(20),
                border: Border.all(
                  color: widget.isOnline ? AppColors.success : AppColors.getBorderColor(widget.isDark),
                  width: 1,
                ),
              ),
              child: Row(
                ...
                children: [
                  Container(
                    ...
                    height: 8,
                    decoration: BoxDecoration(
                      color: widget.isOnline ? AppColors.white : AppColors.getTextHintColor(widget.isDark),
                  ...
                  Text(
                    ...
                    style: TextStyle(
                      color: widget.isOnline ? AppColors.white : AppColors.getTextSecondaryColor(widget.isDark),
                      fontSize: 14,
...
class _StatusCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      padding: const EdgeInsets.all(20),
      decoration: BoxDecoration(
        gradient: isOnline ? AppColors.successGradient : AppColors.primaryGradient,
        borderRadius: BorderRadius.circular(20),
        boxShadow: [
          BoxShadow(
            color: (isOnline ? AppColors.success : AppColors.primary).withOpacity(0.3),
            blurRadius: 20,
          ...
          return Transform.scale(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(
                    color: AppColors.getShadowColor(widget.isDark),
                    blurRadius: 10,
          ...
          children: [
            ...
            TextButton(
              onPressed: () {
                ...
                ModernSnackBar.show(
                  context,
                  message: 'View all rides coming soon!',
                );
              },
              child: Text(
                'View All',
