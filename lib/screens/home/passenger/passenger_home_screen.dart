      ...
      WidgetsBinding.instance.addPostFrameCallback((_) {
        showDialog(
          ...
          builder: (context) => const ModernAlertDialog(
            ...
            message: 'We are excited to have you on board. Your journey with us starts now. Let\'s ride!',
            ...
            Expanded(
              child: _ActionCard(
                ...
                onTap: () {
                  ...
                  ModernSnackBar.show(
                    context,
                    message: 'Ride history coming soon!',
                  );
                },
                isDark: isDark,
              ),
    ...
    return Column(
      ...
      children: [
        ...
        _FeatureItem(
          icon: Icons.security,
          title: 'Safe & Secure',
          subtitle: 'All drivers are verified',
          isDark: isDark,
        ),
        const SizedBox(height: 12),
        _FeatureItem(
          icon: Icons.speed,
          title: 'Fast & Reliable',
          subtitle: 'Quick pickup and drop-off',
          isDark: isDark,
        ),
        const SizedBox(height: 12),
        _FeatureItem(
