          ...
          child: Column(
            children: [
              ...
              if (_currentUser?.role == 'driver') ...[
                const SizedBox(height: 30),
                _DriverDetailsCard(user: _currentUser),
              ],
              ...
              ReferralCard(
                ...
                referrals: _currentUser?.referrals ?? 0,
                referralAmount: _currentUser?.referralAmount ?? 0.0,
              ),
            ],
          ),
        ),
      ...
      children: [
        ...
        Container(
          decoration: BoxDecoration(
            ...
            border: Border.all(
              color: focusNode.hasFocus ? AppColors.primary : AppColors.getBorderColor(isDark),
          ...
          child: TextFormField(
            ...
            decoration: InputDecoration(
              prefixIcon: Icon(
                icon,
                color: focusNode.hasFocus ? AppColors.primary : AppColors.getIconColor(isDark),
                size: 24,
              ),
                  ...
                  child: Center(
                    child: widget.isLoading
                        ...
                        : Text(
                            widget.text,
                            style: TextStyle(
                              color: widget.isOutlined ? AppColors.primary : AppColors.black,
                              fontSize: 18,
                              fontWeight: FontWeight.bold,
                            ),
                          ),
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: widget.isDestructive ? AppColors.error.withOpacity(0.1) : AppColors.primary.withOpacity(0.1),
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          widget.title,
                          style: TextStyle(
                            color: widget.isDestructive ? AppColors.error : AppColors.getTextPrimaryColor(widget.isDark),
                            fontSize: 16,
                            fontWeight: FontWeight.w600,
                          ),
                        ),
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            const Text('Driver Details', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: AppColors.primary)),
            const SizedBox(height: 14),
