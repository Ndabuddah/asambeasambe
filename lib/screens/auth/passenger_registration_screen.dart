    ...
    if (_formKey.currentState!.validate() && _profileImage != null && _photo1 != null && _photo2 != null && _photo3 != null) {
      ...
      try {
        ...
        Navigator.of(context).pushAndRemoveUntil(
          MaterialPageRoute(builder: (context) => const PassengerHomeScreen(isFirstTime: true)),
          (route) => false,
        );
      } catch (e) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Please fill all fields and add all photos.')),
      );
    }
  }
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  _buildPhotoPlaceholder((img) => _photo1 = img, _photo1),
                  _buildPhotoPlaceholder((img) => _photo2 = img, _photo2),
                  _buildPhotoPlaceholder((img) => _photo3 = img, _photo3),
                ],
              ),
